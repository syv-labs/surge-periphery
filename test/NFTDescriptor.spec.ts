...
describe('NFTDescriptor', () => {
  ...
  function constructTokenMetadata(
    ...
    return {
      name: `${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
      description: `This NFT represents a liquidity position ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
