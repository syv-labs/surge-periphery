...
import '@syvlabs/surge-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is Initializable, IQuoterV2, ISwapCallback, PeripheryImmutableState {
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
